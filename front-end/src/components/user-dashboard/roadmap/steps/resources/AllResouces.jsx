    ...
    <div className={`main`}>
      ...
      <div className="detailss ">
        ...
        <div className="cardHeader">
            <h2>{roadmap.title}</h2>
            <Link to={`/user/roadmaps`} className="btn">
              All Roadmaps
            </Link>
            </div>
          <div >
                ...
                {roadmaps.length === 0 ? (
                  ...
                  roadmaps.map((roadmap, index) => (
                    <tr key={roadmap.id}>
                      ...
                      <td>
                        <Link
                          to={`/user/course-edit/${roadmap.id}`}
                          className="link-dark me-3"
                        >
...
//             {/* Your message alert */}
//             <Link to="/user/createcourse" className="btn btn-dark mb-3">
//               Add New
//             </Link>
...
export default UserAllResouces;
